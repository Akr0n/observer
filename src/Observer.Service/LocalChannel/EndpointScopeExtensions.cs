...
public static class EndpointScopeExtensions
{
    ...
    /// <returns>La portata dichiarata, oppure <see cref="EndpointScope.Anywhere"/>.</returns>
    /// <remarks>
    /// Restituisce Anywhere quando il marcatore manca, cioe' la restrizione e' a OPT-IN: e' il
    ...
    /// endpoint risulterebbe Anywhere, cioe' la restrizione sparirebbe in silenzio.
    /// </para>
    /// </remarks>
