...
/// <remarks>
/// Il valore ZERO e' <see cref="Denied"/>: un campo dimenticato o un ramo aggiunto per
...
public enum AccessDecision
{
    ...
    /// <summary>404. L'endpoint non deve nemmeno risultare esistente a questo caller.</summary>
    NotFound,
...
/// <remarks>
/// Il valore ZERO e' <see cref="LocalOnly"/>, cioe' il piu' restrittivo: un endpoint a cui
/// qualcuno scordasse di dichiarare la scope diventa irraggiungibile dalla rete invece che
...
/// file del socket. Qui si verificano due cose soltanto - che il caller sia davvero locale e
...
public static class AccessPolicy
{
    ...
    /// <param name="caller">Come e' stato classificato chi chiama.</param>
    /// <param name="scope">Da dove l'endpoint accetta di essere raggiunto.</param>
    /// <param name="tokenIsValid">Se il bearer token presentato corrisponde.</param>
    ...
    {
        // Il caller locale identificato passa su tutto, senza token. E' l'obiettivo del
        ...
        // Da qui in giu' il caller NON e' un locale identificato.
        ...
        // impersonation lo sceglie il CLIENT, e con Anonymous un caller si rende
